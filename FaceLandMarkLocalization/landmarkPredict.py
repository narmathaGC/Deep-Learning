...
def predictImage(imgPath):
    ...
    for i in range(0,faceNum):
        ...
        result = pose_prediction * 50
        print "YPR ------ ",result[0]
        predictpose[i] = pose_prediction * 50
        print "PosePredictionTime", time.time()-start

        return result[0]   #[pitch,yaw,roll]


print predictImage(imgPath)

##LINK -- https://github.com/qiexing/face-landmark-localization
